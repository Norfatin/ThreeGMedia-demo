  ...
  (function (name, definition) {
    ...
    eventList = {
      cvcInput: [
        ...
        { eventName: "keypress", eventHandler: _eventNormalize(restrictCVC) },
        { eventName: "paste", eventHandler: _eventNormalize(reFormatCVC) },
        { eventName: "change", eventHandler: _eventNormalize(reFormatCVC) },
        { eventName: "input", eventHandler: _eventNormalize(reFormatCVC) },
      ],
      expiryInput: [
        {
          eventName: "keypress",
        ...
        { eventName: "change", eventHandler: _eventNormalize(reFormatExpiry) },
        { eventName: "input", eventHandler: _eventNormalize(reFormatExpiry) },
      ],
      cardNumberInput: [
        {
          eventName: "keypress",
      ...
      numericInput: [
        ...
        { eventName: "paste", eventHandler: _eventNormalize(restrictNumeric) },
        { eventName: "change", eventHandler: _eventNormalize(restrictNumeric) },
        { eventName: "input", eventHandler: _eventNormalize(restrictNumeric) },
      ],
    };
